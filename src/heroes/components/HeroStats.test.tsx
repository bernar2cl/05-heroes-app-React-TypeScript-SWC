...
describe('HeroStats', () => {
  test('should render components with default values', () => {
    ...
    expect(screen.getByText('Cargando héroe...')).toBeDefined();
  ...
  test('should change the percentage of favorite when a hero is added to favorites', () => {
    ...
    const favoritePercentageElment = screen.getByTestId('favorite-percentage');
    expect(favoritePercentageElment.innerHTML).toContain('4,00%');
